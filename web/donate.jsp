		...
		<div class="navbar" role="navigation">
			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li><a href="${pageContext.request.contextPath}/service.jsp">Sevices</a></li>
					...
					<li><a href="event.jsp">Events</a></li>
                                        <li><a href="${pageContext.request.contextPath}/help.jsp">HelpLine</a></li>
					<li class="selected"><a href="${pageContext.request.contextPath}/donate.jsp">Donate</a></li>
                                        <li><a href="${pageContext.request.contextPath}/login.jsp"><c> Login &amp; Register</c></a></li>
				</ul>
			</div>
		</div>
        <div class="container">
