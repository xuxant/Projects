            ...
            <div class="item col-md-4">
               <div class="blok-read-sm">
                ...
                <div class="item col-md-4">
			     ...
			     <div class="divider col-sm-12 col-xs-12 col-md-12">
              <div class="header-text"> <span>With Support Of</span></div>
            </div>
          ...
          <div class="col-md-7 testimonial-blog">
            ...
            <!-- DEMO -->
                <div class="testimonials-slider">
                  <div class="slide">
                    <div class="testimonials-carousel-thumbnail"><img width="120" alt="" src="images/logo.jpg"></div>
                      <div class="testimonials-carousel-context">
                        <div class="testimonials-name">
                          St.Xavier's College <span>sxc.edu.np</span>
                        </div>
                        <div class="testimonials-carousel-content">
                          <p>Tradition - A Call For Innovation</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="slide">
                      <div class="testimonials-carousel-thumbnail">
                        <img width="120" alt="" src="images/hod.jpg">
                      </div>
                      <div class="testimonials-carousel-context">
                        <div class="testimonials-name">Mr. Bishnu Kumar Rana <span>H.O.D of Computer Department</span>
                        </div>
                        <div class="testimonials-carousel-content">
                        <p>Helping Student every way possible.</p>
                        </div>
                      </div>
                    </div>

                      <div class="slide">
                        <div class="testimonials-carousel-thumbnail"><img width="120" alt="" src="images/depart.png"></div>
                          <div class="testimonials-carousel-context">
                            <div class="testimonials-name">Department Of Computer Science<span>St.Xavier's College</span></div>
                              <div class="testimonials-carousel-content">
                                <p>Lead Them in Correct Way. </p>
                              </div>
                            </div>
                      </div>
                    </div>
