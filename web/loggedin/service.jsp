<%-- 
    Document   : service
    Created on : Jul 28, 2017, 2:17:43 PM
    Author     : Sushant
--%>
    ...
    <body>
      ...
      <div class="visible-xs visible-sm col-xs-12 col-sm-12 text-center sm-logo">
        ...
        <div class="navbar" role="navigation">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="selected"><a href="${pageContext.request.contextPath}/loggedin/service.jsp">Sevices</a></li>
                    ...
                    <li><a href="${pageContext.request.contextPath}/loggedin/help.jsp">Help Line</a></li>
        ...
        <div class="divider col-sm-12 col-xs-12 col-md-12">
            <div class="header-text"> <span>How Works Is Being Done</span></div>
        </div>
            ...
            <div id="content" class="container">
                ...
                <div class="posts">
                    ...
                    <div class="post item col-md-4 col-xs-12 col-sm-4">
                           <div class="panel">
                                  <div class="panel-header">
                                     <img src="${pageContext.request.contextPath}/img/comic.jpg" class="img-responsive"  alt="image"/>
                                  </div>
                                  <div class="panel-body">
                                       <h3 class="post-title"><a href="blog-post.jsp">How Comic Books Stop Human Trafficking in Nepal</a></h3>
                    ...
                    <div class="post item col-md-4 col-xs-12 col-sm-4">
                           <div class="panel">
                                  <div class="panel-header">
                                     <img src="${pageContext.request.contextPath}/img/service2.jpg" class="img-responsive"  alt="image"/>
                                  </div>
                                  <div class="panel-body">
                                       <h3 class="post-title"><a href="blog-post2.jsp">Stop commercial sexual exploitation program</a></h3>
                    ...
                    <div class="post item col-md-4 col-xs-12 col-sm-4">
                           <div class="panel">
                                  <div class="panel-header">
                                     <img src="${pageContext.request.contextPath}/img/blog-bg-school-01.jpg" class="img-responsive"  alt="image"/>
                                  </div>
                                  <div class="panel-body">
                                       <h3 class="post-title"><a href="blog-post3.jsp">Support to Women and Girls Working in the Entertainment Sector.</a></h3>
