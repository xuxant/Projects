<%-- 
    Document   : blog-post3
    Created on : Jul 28, 2017, 5:23:52 PM
    Author     : Sushant
--%>
...
<html>
  ...
  <div class="row">
    <div class="col-sm-4">
      ...
      <img src="img/service3.jpg" alt="" width="304" height="300">
    </div>
    <div class="col-sm-8">
      
      <hr>Counseling Awareness Legal mobile (CALM) services :</hr>
      ...
      <div class="col-sm-12">
       <hr>Empowerment and Enrichment Workshop</hr>

        <p>CAP Nepal conducts empowerment and enrichment workshop for its beneficiaries in different social, health and legal topics including life skill trainings to enhance their knowledge and confident level.</p>
    
        <hr>Stakeholder engagement Program:</hr>

        <p>CAP Nepal publishes a magazine named Sankalpa (Commitment) to educate and aware public, boundry actors and policymakers on the issues of commercial sexual exploitation and other abuses linked to it. Similarly CAP Nepal conducts media campaign, media workshops and advocacy programs to establish the right of the female entertainment workers.</p>
      </div>
  </div>
        <!-- Footer -->
        <footer id="footer"> 
